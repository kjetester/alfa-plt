...
public class ContentPageControllerResponseResponse {

  private static final Logger LOGGER =
      LogManager.getLogger(ContentPageControllerResponseResponse.class);
  ...
  @JsonCreator
  private ContentPageControllerResponseResponse(
