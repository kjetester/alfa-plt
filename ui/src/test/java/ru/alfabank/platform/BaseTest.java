...
import ru.alfabank.platform.buisenessobjects.enums.Device;
...
public class BaseTest {
  ...
  private void setUpSourcePage() {
    ...
    sourcePage = new Page.PageBuilder()
        .setUri("/about/")
        .setId(10)
        .setTitle("null")
        .setDescription("null")
  ...
  private void setUpContentPageControllerRequestConfiguration() {
    ...
    contentPageControllerSpec = new RequestSpecBuilder()
        ...
        .addQueryParam("device", Device.DESKTOP)
        .build();
  }
