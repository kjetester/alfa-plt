...
public class StatusCbBaseTest extends BaseTest {
   ...
   */
  @DataProvider
  public static Object[][] statusCbPositiveTestDataProvider() {
    return new Object[][]{
        {
            "statusCb == DO",
            new Offices(
   ...
   */
  @DataProvider
  public static Object[][] statusCbNegativeTestDataProvider() {
    return new Object[][]{
        {
            "statusCb == OKVKU",
            new Offices(
