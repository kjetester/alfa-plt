...
public class LocationsUpdateBaseTest extends UpdateBaseTest {
   ...
   */
  @DataProvider
  public static Object[][] locationsUpdatePositiveTestDataProvider() {
    return new Object[][]{
        {
            "smoke",
            new Offices(
   ...
   */
  @DataProvider
  public static Object[][] locationsUpdateNegativeTestDataProvider() {
    return new Object[][]{
        {
